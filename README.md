...
- **BERTopic base model:** `sentence-transformers/all-mpnet-base-v2`
...
1. **Privacy:** Current methods track users over months; post-level analysis enables immediate assessment without longitudinal tracking
...
```
[Author Name] (2025). Post-Level Emotion Network Analysis for Mental Health Crisis Detection
in Online Communities. Data Science Research Project, University of Adelaide.
```

## License

This project is for academic research purposes. Mental health data should be handled ethically with appropriate privacy safeguards.
